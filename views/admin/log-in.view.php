<div class="mx-auto max-w-sm py-12">
    <h2 class="mb-8 text-center font-display font-bold text-accent" style="font-size: var(--fluid-lg);">Log In</h2>

    <form action="index.php?<?= route_url(['route' => 'admin/log-in']) ?>" method="post" id="log-in-form"
        ...
        <?php if ($error): ?>
            <p class="text-sm text-martian-600">Either user or password are incorrect.</p>
        <?php endif; ?>
